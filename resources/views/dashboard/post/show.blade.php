...
<div class="container-fluid py-4 mt-2">
    <div class="row">
        <div class="col-lg-8">
            ...
            <p>Dibuat pada {{ date('d/m/Y', strtotime($post->created_at)) }}</p>
            <a class="btn btn-success" onClick="javascript:history.back()">Kembali</a>
            <a href="/dashboard/myarticle/{{ $post->slug }}/edit" class="btn btn-warning"><span
                    data-feather="edit"></span>Edit</a>
            {{-- <a href="" class="btn btn-danger"><span data-feather="x-circle"></span>Delete</a> --}}
            <form action="/dashboard/myarticle/{{ $post->slug }}" method="post" class="d-inline">
                @method('delete')
                @csrf
